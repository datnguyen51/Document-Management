def format_html_mail_forgot_pass(username, password):
    html = """
        <head>
        <style type="text/css">
            #outlook a {
                                                            ...
                                                            <table width="100%" cellspacing="0" cellpadding="0"
                                                                ...
                                                                <tr style="border-collapse:collapse">
                                                                    <td align="center"
                                                                        ...
                                                                        <img src="https://lmhcrp.stripocdn.email/content/guids/CABINET_dd354a98a803b60e2f0411e893c82f56/images/23891556799905703.png"
                                                                            alt
                                                                            style="display:block;border:0;outline:none;text-decoration:none;-ms-interpolation-mode:bicubic"
                                                                            width="175"></td>
                                                                </tr>
                                                                ...
                                                                <tr style="border-collapse:collapse">
                                                                    <td align="center"
                                                                        ...
                                                                        <p
                                                                            style="Margin:0;-webkit-text-size-adjust:none;-ms-text-size-adjust:none;mso-line-height-rule:exactly;font-family:helvetica, 'helvetica neue', arial, verdana, sans-serif;line-height:24px;color:#666666;font-size:16px">
                                                                            If this request is not made, simply ignore this
                                                                            email. If not, please login with the new
                                                                            password:</p>
                                                                    </td>
                                                                </tr>
                                                                <tr style="border-collapse:collapse">
